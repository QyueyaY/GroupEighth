...
//    void insertContent(ContentVo contentVo);
     ...
     * @return ContentVo
     */
    PageInfo<ContentVo> getArticles(String keyword,Integer page,Integer limit,String order);
    ...
    PageInfo<ContentVo> getArticlesWithpage(ContentVoExample commentVoExample, Integer page, Integer limit,String order);
    /**
     * 根据文章id删除
     * @param cid
     */
    ...
    * 按分类搜索
     */
    PageInfo<ContentVo> getArticlesWithCate(ContentVoExample contentVoExample, int page, int limit, String categorites);
}
